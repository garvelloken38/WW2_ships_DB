...
В базе собрана информация о кораблях, участвовавших во Второй Мировой войне. По заданию необходимо было добавить таблицу с версионными данными - я добавил возможность менять капитанов в таблице с кораблями. 
